...
<div class="container">
    <div class="card">
      ...
      <form class="formulario" action="ServletAutor?accion=buscar" method="post">
        <input id="campoTextoAutor" type="text" placeholder="Nombre" maxlength="20" name="nombre"required>
	    <input id="campoTextoAutor" type="text" placeholder="Apellido" maxlength="20" name="apellido"required>               
